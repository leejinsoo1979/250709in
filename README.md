...
- **[Git 자동 커밋·LFS·CI 가이드 (PDF)](docs/Git_Autocommit_LFS_CI_Guide.pdf)** - 자동 체크포인트, Git LFS, CI/CD 설정 가이드
- **[Git Workflow 문서](docs/GIT_WORKFLOW.md)** - 상세한 Git 워크플로우 및 베스트 프랙티스
