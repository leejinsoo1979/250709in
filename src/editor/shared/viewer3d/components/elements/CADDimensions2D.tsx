    ...
    return (
      <group>
        ...
        <group>
          ...
          <NativeLine
            points={[
              [0, floatHeight, -spaceDepth/2 + mmToThreeUnits(190)],
          ...
          <NativeLine
            points={[
              [0, floatHeight + spaceHeight, -spaceDepth/2 + mmToThreeUnits(190)],
        ...
        {topFrameHeightMm > 0 && (
          <group>
            ...
            <NativeLine
              points={[
                [0, floatHeight + spaceHeight - topFrameHeight, spaceDepth/2 + rightDimOffset - mmToThreeUnits(750) - mmToThreeUnits(440)],
            ...
            <NativeLine
              points={[
                [0, floatHeight + spaceHeight, spaceDepth/2 + rightDimOffset - mmToThreeUnits(750) - mmToThreeUnits(440)],
                ...
                <NativeLine
                  points={[
                    [0,
                      ...
                      spaceDepth/2 + rightDimOffset - mmToThreeUnits(750) - mmToThreeUnits(440)],
                    [0,
                      is2Drawer ? sectionStartY : (sectionStartY - basicThickness),
        ...
        <group>
            ...
            <NativeLine
              points={[
                [0, 0, spaceDepth/2 + rightDimOffset - mmToThreeUnits(750) - mmToThreeUnits(440)],
            ...
            <NativeLine
              points={[
                [0, floatHeight + baseFrameHeight, spaceDepth/2 + rightDimOffset - mmToThreeUnits(750) - mmToThreeUnits(440)],
