      ...
      <group>
        ...
        {topFrameHeightMm > 0 && (
          <group>
            ...
            <NativeLine
              points={[
                [0, floatHeight + spaceHeight - topFrameHeight, spaceDepth/2 + rightDimOffset - mmToThreeUnits(750) - mmToThreeUnits(400)],
            ...
            <NativeLine
              points={[
                [0, floatHeight + spaceHeight, spaceDepth/2 + rightDimOffset - mmToThreeUnits(750) - mmToThreeUnits(400)],
        ...
        {placedModules.slice(0, 1).map((module, moduleIndex) => {
          ...
          return sections.map((section, sectionIndex) => {
            ...
            if (isLastSection) {
              ...
              // 2단: 하부 측판이 18mm 늘어나서 sectionEndY (상부 시작점과 만남)
              // 4단: 하부 측판 조정 없어서 sectionEndY - basicThickness (하부 상판 윗면)
              const lineStart = floatHeight + baseFrameHeight;
              const lineEnd = is2Drawer ? sectionEndY : (sectionEndY - basicThickness);
              sectionHeightMm = (lineEnd - lineStart) / 0.01;
            } else {
              // 중간 섹션: 섹션 자체 높이
                ...
                <NativeLine
                  points={[
                    [0,
                      ...
                      spaceDepth/2 + rightDimOffset - mmToThreeUnits(750) - mmToThreeUnits(400)],
                    [0,
                      is2Drawer ? sectionStartY : (sectionStartY - basicThickness),
        ...
        <group>
            ...
            <NativeLine
              points={[
                [0, 0, spaceDepth/2 + rightDimOffset - mmToThreeUnits(750) - mmToThreeUnits(400)],
            ...
            <NativeLine
              points={[
                [0, floatHeight + baseFrameHeight, spaceDepth/2 + rightDimOffset - mmToThreeUnits(750) - mmToThreeUnits(400)],
