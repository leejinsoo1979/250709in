          ...
          return sections.map((section, sectionIndex) => {
            ...
            return (
              <group key={`section-${moduleIndex}-${sectionIndex}`}>
                ...
                <NativeLine
                  points={[
                    [slotX, sectionStartY, -spaceDepth/2 - leftDimOffset + mmToThreeUnits(500) + mmToThreeUnits(400)],
                    [slotX, sectionStartY, -spaceDepth/2 - leftDimOffset + mmToThreeUnits(500)]
                  ]}
                  color={dimensionColor}
                  lineWidth={1}
                  renderOrder={100000}
                ...
                <NativeLine
                  points={[
                    [slotX - 0.03, sectionStartY, -spaceDepth/2 - leftDimOffset + mmToThreeUnits(500)],
                    [slotX + 0.03, sectionStartY, -spaceDepth/2 - leftDimOffset + mmToThreeUnits(500)]
                  ]}
                  color={dimensionColor}
                  lineWidth={2}
                ...
                {shouldRenderStartGuide && (
                <mesh
                  position={[slotX, sectionStartY, -spaceDepth/2 - leftDimOffset + mmToThreeUnits(500)]}
                  renderOrder={100001}
                  rotation={[0, Math.PI / 2, 0]}
                >
                  <circleGeometry args={[0.06, 16]} />
