  ...
  return (
    <group>
      ...
      <group>
        ...
        <Line
          points={[
            [dimensionOffsetX, 0, 0.01],
            [dimensionOffsetX, spaceHeight, 0.01]
          ]}
          color="#1976d2"
          lineWidth={2}
        />
        ...
        <Line
          points={createArrow(
            new THREE.Vector3(dimensionOffsetX, 0, 0.01),
            new THREE.Vector3(dimensionOffsetX, 0.05, 0.01)
          )}
          color="#1976d2"
          lineWidth={2}
        />
        ...
        <Line
          points={createArrow(
            new THREE.Vector3(dimensionOffsetX, spaceHeight, 0.01),
            new THREE.Vector3(dimensionOffsetX, spaceHeight - 0.05, 0.01)
          )}
          color="#1976d2"
          lineWidth={2}
        />
        ...
        {/* 치수 텍스트 */}
        <Html
          position={[dimensionOffsetX - mmToThreeUnits(80), spaceHeight / 2, 0.01]}
          center
          transform={false}
          occlude={false}
          zIndexRange={[1000, 1001]}
        ...
        <Line
          points={[
            [0, 0, 0.01],
            [dimensionOffsetX - mmToThreeUnits(20), 0, 0.01]
          ]}
          color="#1976d2"
          lineWidth={1}
          dashed
        ...
        <Line
          points={[
            [0, spaceHeight, 0.01],
            [dimensionOffsetX - mmToThreeUnits(20), spaceHeight, 0.01]
          ]}
          color="#1976d2"
          lineWidth={1}
          dashed
