      ...
      <group>
        ...
        {currentViewDirection === 'left' && (
          <group>
            ...
            <Line
              points={[
                [0, floatHeight, -spaceDepth/2 - mmToThreeUnits(150)],
                [0, floatHeight + spaceHeight, -spaceDepth/2 - mmToThreeUnits(150)]
              ]}
            ...
            <Line
              points={[
                [0, floatHeight + spaceHeight - 0.02, -spaceDepth/2 - mmToThreeUnits(150)],
                [0, floatHeight + spaceHeight, -spaceDepth/2 - mmToThreeUnits(150)],
                [-0.015, floatHeight + spaceHeight - 0.015, -spaceDepth/2 - mmToThreeUnits(150)]
              ]}
              color={dimensionColors.primary}
              lineWidth={2}
            />
            ...
            <Line
              points={[
                [0, floatHeight + 0.02, -spaceDepth/2 - mmToThreeUnits(150)],
                [0, floatHeight, -spaceDepth/2 - mmToThreeUnits(150)],
                [-0.015, floatHeight + 0.015, -spaceDepth/2 - mmToThreeUnits(150)]
              ]}
              color={dimensionColors.primary}
              lineWidth={2}
            />
            ...
            {showDimensionsText && (
              <Html
                position={[0, floatHeight + spaceHeight / 2, -spaceDepth/2 - mmToThreeUnits(250)]}
                center
                transform={false}
                occlude={false}
          ...
          <group>
            ...
            {topFrameHeightMm > 0 && (
              <group>
                <Line
                  points={[
                    [0, floatHeight + spaceHeight - topFrameHeight, spaceDepth/2 + mmToThreeUnits(150)],
                    [0, floatHeight + spaceHeight, spaceDepth/2 + mmToThreeUnits(150)]
                  ]}
                  color={dimensionColors.primary}
                  lineWidth={2}
                ...
                <Line
                  points={[
                    [0, floatHeight + spaceHeight - topFrameHeight + 0.02, spaceDepth/2 + mmToThreeUnits(150)],
                    [0, floatHeight + spaceHeight - topFrameHeight, spaceDepth/2 + mmToThreeUnits(150)],
                    [-0.015, floatHeight + spaceHeight - topFrameHeight + 0.015, spaceDepth/2 + mmToThreeUnits(150)]
                  ]}
                  color={dimensionColors.primary}
                  lineWidth={2}
                />
                ...
                {showDimensionsText && (
                  <Html
                    position={[0, floatHeight + spaceHeight - topFrameHeight / 2, spaceDepth/2 + mmToThreeUnits(250)]}
                    center
                    transform={false}
                    occlude={false}
                    zIndexRange={[1000, 1001]}
            ...
            <group>
              <Line
                points={[
                  [0, floatHeight + baseFrameHeight, spaceDepth/2 + mmToThreeUnits(150)],
                  [0, floatHeight + baseFrameHeight + internalHeight, spaceDepth/2 + mmToThreeUnits(150)]
                ]}
              ...
              <Line
                points={[
                  [0, floatHeight + baseFrameHeight + 0.02, spaceDepth/2 + mmToThreeUnits(150)],
                  [0, floatHeight + baseFrameHeight, spaceDepth/2 + mmToThreeUnits(150)],
                  [-0.015, floatHeight + baseFrameHeight + 0.015, spaceDepth/2 + mmToThreeUnits(150)]
                ]}
                color={dimensionColors.furniture}
                lineWidth={2}
              />
              ...
              <Line
                points={[
                  [0, floatHeight + baseFrameHeight + internalHeight - 0.02, spaceDepth/2 + mmToThreeUnits(150)],
                  [0, floatHeight + baseFrameHeight + internalHeight, spaceDepth/2 + mmToThreeUnits(150)],
                  [-0.015, floatHeight + baseFrameHeight + internalHeight - 0.015, spaceDepth/2 + mmToThreeUnits(150)]
                ]}
                color={dimensionColors.furniture}
                lineWidth={2}
              />
              ...
              {showDimensionsText && (
                <Html
                  position={[0, floatHeight + baseFrameHeight + internalHeight / 2, spaceDepth/2 + mmToThreeUnits(250)]}
                  center
                  transform={false}
                  occlude={false}
                  zIndexRange={[1000, 1001]}
            ...
            {baseFrameHeightMm > 0 && (
              <group>
                ...
                {showDimensionsText && (
                  <Html
                    position={[0, floatHeight + baseFrameHeight / 2, spaceDepth/2 + mmToThreeUnits(250)]}
                    center
                    transform={false}
                    occlude={false}
                    zIndexRange={[1000, 1001]}
