          ...
          <group>
            ...
            <NativeLine
              points={[
                ...
                [0, floatHeight + spaceHeight - topFrameHeight, -spaceDepth/2 - leftDimOffset]
              ]}
              color={dimensionColor}
              lineWidth={1}
              renderOrder={100000}
            ...
            <NativeLine
              points={[
                [-0.03, floatHeight + spaceHeight - topFrameHeight, -spaceDepth/2 - leftDimOffset],
                [0.03, floatHeight + spaceHeight - topFrameHeight, -spaceDepth/2 - leftDimOffset]
              ]}
              color={dimensionColor}
              lineWidth={2}
            ...
            />
            <Text
              position={[0, floatHeight + spaceHeight - topFrameHeight / 2, -spaceDepth/2 - leftDimOffset - mmToThreeUnits(60)]}
              fontSize={largeFontSize}
              color={textColor}
              anchorX="center"
              anchorY="middle"
            ...
            return (
              <group key={`section-${moduleIndex}-${sectionIndex}`}>
                ...
                <NativeLine
                  points={[
                    [slotX - 0.03,
                      isLastSection ? (floatHeight + baseFrameHeight + internalHeight - basicThickness - mmToThreeUnits(75)) :
                      sectionIndex === 0 ? (sectionEndY - basicThickness) :
                      sectionEndY,
                      spaceDepth/2 + rightDimOffset - mmToThreeUnits(500)],
                    [slotX + 0.03,
