      ...
      return (
        <group key={`section-${index}`}>
          ...
          {(() => {
            ...
            // 정면뷰에서도 섹션 내경 치수 숨김 (중복 방지)
            const shouldShow = false; // 모든 섹션 내경 치수 비활성화
              ...
              {(() => {
                ...
                return (
                  <>
                    ...
                    {topCompartmentHeight !== null && topCompartmentBottomY !== null && topCompartmentTopY !== null && !isDualFurniture && (
                      <>
                        {(() => {
