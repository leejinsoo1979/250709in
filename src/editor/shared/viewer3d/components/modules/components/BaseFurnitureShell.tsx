                      ...
                      <group>
                        ...
                        <NativeLine
                          start={[
                            ...
                            -innerWidth/2 * 0.3,
                            lowerTopPanelY + basicThickness * 1.5,
                            viewMode === '3D' ? depth/2 + 0.1 : depth/2 + 1.0
                          ]}
                        ...
                        {/* 엔드포인트 (하단) */}
                        <mesh position={[-innerWidth/2 * 0.3, lowerTopPanelY + basicThickness/2, viewMode === '3D' ? depth/2 + 0.1 : depth/2 + 1.0]}>
                          <sphereGeometry args={[0.05, 8, 8]} />
                          <meshBasicMaterial color={dimensionColor} />
                        </mesh>
                        
                        {/* 엔드포인트 (상단) */}
                        <mesh position={[-innerWidth/2 * 0.3, lowerTopPanelY + basicThickness * 1.5, viewMode === '3D' ? depth/2 + 0.1 : depth/2 + 1.0]}>
                          <sphereGeometry args={[0.05, 8, 8]} />
                          <meshBasicMaterial color={dimensionColor} />
                        </mesh>
                      </group>
