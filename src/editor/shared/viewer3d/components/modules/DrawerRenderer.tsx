...
export const DrawerRenderer: React.FC<DrawerRendererProps> = ({
  ...
  // 수평 패널 공통 치수
  const horizontalPanelWidth = drawerFrameThickness; // X축 폭: 18mm (수직패널에서 측판쪽으로 돌출)
  ...
  const frontHorizontalPanelZ = -depth/2 + basicThickness + horizontalPanelDepthBack/2;
