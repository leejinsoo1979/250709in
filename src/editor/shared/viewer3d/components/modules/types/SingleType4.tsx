...
const SingleType4: React.FC<FurnitureTypeProps> = ({
  ...
  return (
    <>
      ...
      {showFurniture && (
        <BaseFurnitureShell {...baseFurniture} isDragging={isDragging} isEditMode={isEditMode} spaceInfo={spaceInfo} moduleData={moduleData} placedFurnitureId={placedFurnitureId} lowerSectionDepthMm={baseFurniture.lowerSectionDepthMm} upperSectionDepthMm={baseFurniture.upperSectionDepthMm}>
