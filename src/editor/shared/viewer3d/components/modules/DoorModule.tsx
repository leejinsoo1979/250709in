              ...
              <group position={[0, 0, doorThicknessUnits / 2 + 0.001]}>
                ...
                {(() => {
                  ...
                  const start1 = isFrontView
                    ...
                    : [adjustedHingePosition === 'left' ? doorThicknessUnits / 2 : -doorThicknessUnits / 2, -doorHeight / 2, 0];
                  const end1 = isFrontView
                    ? [adjustedHingePosition === 'left' ? -doorWidthUnits / 2 : doorWidthUnits / 2, 0, 0]
                    : [adjustedHingePosition === 'left' ? -doorThicknessUnits / 2 : doorThicknessUnits / 2, 0, 0];
                  const segments1 = [];
