...
interface UIState {
  ...
  guideDepthZone: 'upper' | 'lower';
  setGuideDepthZone: (zone: 'upper' | 'lower') => void;
...
const initialUIState = {
  ...
  guideDepthZone: 'upper' as const,  // 가이드 깊이 편집 상/하부 선택
...
//         });
      ...
      setGuideDepthZone: (zone: 'upper' | 'lower') =>
        set({ guideDepthZone: zone }),
