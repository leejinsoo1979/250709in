...
export const faqData: FAQ[] = [
  ...
  // 챗봇 관리 (관리자용)
  {
    keywords: ['챗봇', 'chatbot', '챗봇관리', '챗봇설정', '관리'],
    answer: '관리자 대시보드에서 "챗봇 관리" 메뉴를 통해 챗봇 설정을 변경할 수 있습니다. 인사말, 기본 메시지, FAQ 질문/답변을 수정할 수 있습니다.',
  },
  {
    keywords: ['인사말', 'greeting', '챗봇인사말', '환영메시지'],
    answer: '챗봇 관리 페이지에서 인사말을 수정할 수 있습니다. 챗봇이 처음 열릴 때 사용자에게 표시되는 메시지입니다.',
  },
  {
    keywords: ['기본메시지', 'default message', '기본답변', '매칭실패'],
    answer: '기본 메시지는 사용자의 질문이 FAQ와 매칭되지 않을 때 표시됩니다. 챗봇 관리 페이지에서 수정할 수 있습니다.',
  },
  {
    keywords: ['FAQ', 'faq', '질문답변', 'Q&A', 'qa'],
    answer: 'FAQ 관리에서 자주 묻는 질문과 답변을 추가, 수정, 삭제할 수 있습니다. 각 질문마다 여러 키워드를 설정하여 다양한 표현으로 검색 가능합니다.',
  },
];
