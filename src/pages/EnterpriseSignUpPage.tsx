        ...
        {checkingExisting ? (
          ...
          >
            ...
            <p className="text-zinc-400 text-sm mb-8 leading-relaxed">
              이메일 인증 링크를 발송했습니다. 메일함에서 인증을 완료해주세요.<br />
                ...
                <Field label="로그인 이메일" required>
                  <div className="flex gap-3">
                    <input
                      ...
                      autoComplete="email"
                      className="flex-1 bg-zinc-900 border rounded-xl px-4 py-3 text-white text-sm placeholder:text-zinc-600 focus:outline-none transition-colors border-white/30 focus:border-zinc-500"
                    />
                  </div>
